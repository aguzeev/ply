...
if ($database_id == 'new') {
	// добавляем новый виджет
		...
		$sqlCP = "INSERT INTO `control_pannel_presets` (`id`, `user_id`, `order`, `type`, `machine`, `variant`, `period`) VALUES (NULL, '" . $_SESSION['v2_user_id'] . "', '" . $order . "', '" . $machine . "', '" . $variant . "', '" . $period . "')";
		// echo '<br>' . $sqlCP . '<br>';
