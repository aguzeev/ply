...
/* Описание групп и прав пользователей
Штатное расписание
Расценки на выполненные работы
Объём выполненных показателей
Количество человек на участке, КТУ
Количество отработанных часов
Редактирование перечня должностей и перечня операций
Редактирование соответствия операций должностям
...
if (empty($_POST))
{
	...
	<h3>Редактирование групп пользователей</h3>
